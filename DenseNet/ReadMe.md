This is the implementation of the paper titled "Densely Connected Convolutional Networks" [1] using Keras. It then uses the CIFAR-10 dataset to train the model.
