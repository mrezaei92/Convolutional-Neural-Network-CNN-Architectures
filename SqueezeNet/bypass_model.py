...
nb_classes=1000 # the number of classes
...
bypass1=Add()([merge2,merge3])

merge4=fire_module(bypass1,32,128,4)

maxpool4 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='maxpool4')(merge4)

merge5=fire_module(maxpool4,32,128,5)

bypass2=Add()([maxpool4,merge5])

merge6=fire_module(bypass2,48,192,6)

merge7=fire_module(merge6,48,192,7)

bypass3=Add()([merge6,merge7])

merge8=fire_module(bypass3,64,256,8)
...
bypass4=Add()([maxpool8,fire9_dropout])

conv10 = Conv2D(nb_classes, (1, 1), activation='relu', kernel_initializer='glorot_uniform',padding='valid', name='conv10')(bypass4)
